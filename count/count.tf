resource "aws_instance" "web" {
  ...
  ami           = var.ami_id
  instance_type = var.instances_names[count.index] == "mongodb" || var.instances_names[count.index] == "mysql" || var.instances_names[count.index] == "shipping" ? "t3.small" : "t2.micro" # This is the condition
